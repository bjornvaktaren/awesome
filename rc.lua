...
globalkeys = gears.table.join(
   ...
   -- 	 awful.util.spawn("cp /home/mikael/.config/awesome/themes/xfce4-terminalrc-solarized-light /home/.config/xfce4/terminal/terminalrc", false)
   -- end),
   -- awful.key({modkey, 'Shift'}, "r", function ()
   -- 	 awful.util.spawn("cp /home/mikael/.config/awesome/themes/xfce4-terminalrc-solarized-dark /home/.config/xfce4/terminal/terminalrc", false)
   -- end),
   -- Volume Keys
